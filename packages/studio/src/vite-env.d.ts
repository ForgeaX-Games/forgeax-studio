...
// null in studio (multi-game: the active game is resolved at runtime from the
// server authority or managed-carrier scope, not baked at build). Mirrors the editor
